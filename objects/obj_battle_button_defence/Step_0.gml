if(obj_battle.battle_state==BATTLE_STATES.player&&obj_battle.battle_button_state==BATTLE_BUTTON_STATE.button_choice&&obj_battle.button_choice[obj_battle.battle_chara_now]==4){//player's round
	image_index=1;
	tarscale=1.1;
